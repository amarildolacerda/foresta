  ...
  Widget build(BuildContext context) {
    return MobileBottonNavigatorButton(
      ...
      choices: [
        ...
        TabChoice(
            image: const Icon(Icons.home, size: 35, color: Colors.grey),
            onPressed: () {
              //Navigator.popUntil(context, ModalRoute.withName('/'));
              Navigator.popAndPushNamed(context, '/');
            }),
        TabChoice(
            image: const Icon(Icons.notifications_none,
...
// automaticallyImplyLeading: false,
                    ...
                    body: const DashEventosView(),
                    bottomNavigationBar:
                        const BarraNavegacaoPadrao(itemIndex: 2),
                  ));
            },
            builder: () {
